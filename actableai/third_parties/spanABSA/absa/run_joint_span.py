...
def run_train_epoch(
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        batch_start_logits, batch_end_logits, _ = model(
            "extract_inference",
            input_mask,
            input_ids=input_ids,
        ...
        span_starts, span_ends, labels, label_masks = span_annotate_candidates(
            train_examples,
            batch_features,
            batch_results,
            args.filter_type,
...
def evaluate(
    ...
    for batch in eval_dataloader:
        ...
        with torch.no_grad():
            batch_start_logits, batch_end_logits, sequence_output = model(
                "extract_inference",
                input_mask,
                input_ids=input_ids,
                token_type_ids=segment_ids,
...
def main():
    ...
    train_examples, train_features, train_dataloader, num_train_steps = (
        None,
        None,
        None,
        None,
    ...
    if args.do_train:
        ...
        (
            ...
            train_dataloader,
            num_train_steps,
        ) = read_train_data(args, tokenizer, logger)
